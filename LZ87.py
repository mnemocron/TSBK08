    ...
    while True:
        ...
        for i in range(len(list)):
            ...
            if(list_byte == data_byte):
                ### Match!!!
                # Need to look at the deepest byte ex: (1,b) 
                # need to look at byte 1 before b and so on until None is the byte
